...
/**
 * \file theme.c    Making Finestra look pretty
 *
 * The window decorations drawn by Finestra are described by files on disk
 * known internally as "themes" (externally as "window border themes" on
 * http://art.gnome.org/themes/finestra/ or "Finestra themes"). This file
 ...
 * called from outside Finestra, in which case env->theme will be NULL, and
