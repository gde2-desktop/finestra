                         ...
                         MetaGradientType type)
{
  ...
  switch (type)
    ...
    case META_GRADIENT_VERTICAL:
      g_printerr ("finestra: vertical alpha channel gradient not implemented yet\n");
      break;

    case META_GRADIENT_DIAGONAL:
      g_printerr ("finestra: diagonal alpha channel gradient not implemented yet\n");
      break;
