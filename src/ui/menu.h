...
/* Stock icons */
#define FINESTRA_STOCK_DELETE   "window-close"
#define FINESTRA_STOCK_RESTORE  "view-restore"
#define FINESTRA_STOCK_MINIMIZE "go-down"
#define FINESTRA_STOCK_MAXIMIZE "view-fullscreen"
