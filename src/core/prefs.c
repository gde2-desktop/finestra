 ...
 */
#define KEY_GENERAL_SCHEMA "org.gde2.Finestra.general"
...
#define KEY_COMMAND_SCHEMA "org.gde2.Finestra.keybinding-commands"
#define KEY_COMMAND_PREFIX "command-"

#define KEY_SCREEN_BINDINGS_SCHEMA "org.gde2.Finestra.global-keybindings"

#define KEY_WINDOW_BINDINGS_SCHEMA "org.gde2.Finestra.window-keybindings"

#define KEY_WORKSPACE_NAME_SCHEMA "org.gde2.Finestra.workspace-names"
#define KEY_WORKSPACE_NAME_PREFIX "name-"

#define KEY_GDE2_INTERFACE_SCHEMA "org.gde2.interface"
#define KEY_GDE2_INTERFACE_ACCESSIBILITY "accessibility"
#define KEY_GDE2_INTERFACE_ENABLE_ANIMATIONS "enable-animations"

#define KEY_GDE2_TERMINAL_SCHEMA "org.gde2.applications-terminal"
#define KEY_GDE2_TERMINAL_COMMAND "exec"

#define KEY_GDE2_MOUSE_SCHEMA "org.gde2.peripherals-mouse"
#define KEY_GDE2_MOUSE_CURSOR_THEME "cursor-theme"
#define KEY_GDE2_MOUSE_CURSOR_SIZE "cursor-size"
...
static GSettings *settings_gde2_interface;
static GSettings *settings_gde2_terminal;
static GSettings *settings_gde2_mouse;
...
static gboolean gde2_accessibility = FALSE;
static gboolean gde2_animations = TRUE;
...
/* @@@ /apps/finestra/general should be assumed if first char is not / */
...
static MetaBoolPreference preferences_bool[] =
  {
    ...
    { "accessibility",
      KEY_GDE2_INTERFACE_SCHEMA,
      META_PREF_GDE2_ACCESSIBILITY,
      &gde2_accessibility,
      FALSE,
    },
    { "enable-animations",
      KEY_GDE2_INTERFACE_SCHEMA,
      META_PREF_GDE2_ANIMATIONS,
      &gde2_animations,
      TRUE,
    },
...
static MetaStringPreference preferences_string[] =
  {
    ...
    { KEY_GDE2_TERMINAL_COMMAND,
      KEY_GDE2_TERMINAL_SCHEMA,
...
handle_preference_update_int (const gchar *key, GSettings *settings)
{
  ...
  if (value < cursor->minimum || value > cursor->maximum)
    {
      /* FIXME! GSettings, instead of Gde2Conf, has Minimum/Maximun in schema!
...
meta_prefs_init (void)
{
  ...
  settings_gde2_interface = g_settings_new (KEY_GDE2_INTERFACE_SCHEMA);
  settings_gde2_terminal = g_settings_new (KEY_GDE2_TERMINAL_SCHEMA);
  settings_gde2_mouse = g_settings_new (KEY_GDE2_MOUSE_SCHEMA);
  ...
  g_hash_table_insert (settings_schemas, KEY_GDE2_INTERFACE_SCHEMA, settings_gde2_interface);
  g_hash_table_insert (settings_schemas, KEY_GDE2_TERMINAL_SCHEMA, settings_gde2_terminal);
  g_hash_table_insert (settings_schemas, KEY_GDE2_MOUSE_SCHEMA, settings_gde2_mouse);
  ...
  g_signal_connect (settings_gde2_interface, "changed::" KEY_GDE2_INTERFACE_ACCESSIBILITY, G_CALLBACK (change_notify), NULL);
  g_signal_connect (settings_gde2_interface, "changed::" KEY_GDE2_INTERFACE_ENABLE_ANIMATIONS, G_CALLBACK (change_notify), NULL);
  g_signal_connect (settings_gde2_terminal, "changed::" KEY_GDE2_TERMINAL_COMMAND, G_CALLBACK (change_notify), NULL);
  g_signal_connect (settings_gde2_mouse, "changed::" KEY_GDE2_MOUSE_CURSOR_THEME, G_CALLBACK (change_notify), NULL);
  g_signal_connect (settings_gde2_mouse, "changed::" KEY_GDE2_MOUSE_CURSOR_SIZE, G_CALLBACK (change_notify), NULL);
               ...
               gpointer user_data)
{
  ...
  if (g_strcmp0 (schema_name, KEY_WINDOW_BINDINGS_SCHEMA) == 0 ||
  ...
  else
    {
      ...
      meta_topic (META_DEBUG_PREFS, "Key %s doesn't mean anything to Finestra\n",
                  key);
    }
  g_free (schema_name);
}
...
meta_preference_to_string (MetaPreference pref)
{
  ...
  switch (pref)
    ...
    case META_PREF_GDE2_ACCESSIBILITY:
      return "GDE2_ACCESSIBILTY";

    case META_PREF_GDE2_ANIMATIONS:
      return "GDE2_ANIMATIONS";
...
{
  return KEY_GDE2_TERMINAL_COMMAND;
}
...
gboolean
meta_prefs_get_gde2_accessibility ()
{
  return gde2_accessibility;
}

gboolean
meta_prefs_get_gde2_animations ()
{
  return gde2_animations;
}
