                  ...
                  guint32     timestamp)
{
  ...
  /*
    finestra-dialog said:

    FIXME offer to change the value of the command's gde2conf key
  */
                         ...
                         MetaKeyBinding *binding)
{
  ...
  switch (action)
    ...
    case META_KEYBINDING_ACTION_PANEL_MAIN_MENU:
      action_atom = display->atom__GDE2_PANEL_ACTION_MAIN_MENU;
      break;
    case META_KEYBINDING_ACTION_PANEL_RUN_DIALOG:
      action_atom = display->atom__GDE2_PANEL_ACTION_RUN_DIALOG;
      break;
    default:
      return;
    }
  ...
  ev.message_type = display->atom__GDE2_PANEL_ACTION;
  ev.format = 32;
