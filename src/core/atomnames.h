 ...
 *
 * This is a list of the names of all the X atoms that Finestra uses.
...
item(WM_ICON_SIZE)
item(_KWM_WIN_ICON)
item(_FINESTRA_RESTART_MESSAGE)
item(_FINESTRA_RELOAD_THEME_MESSAGE)
item(_FINESTRA_SET_KEYBINDINGS_MESSAGE)
item(_FINESTRA_TOGGLE_VERBOSE)
item(_GTK_FRAME_EXTENTS)
item(_GDE2_PANEL_ACTION)
item(_GDE2_PANEL_ACTION_MAIN_MENU)
item(_GDE2_PANEL_ACTION_RUN_DIALOG)
item(_FINESTRA_SENTINEL)
item(_FINESTRA_VERSION)
